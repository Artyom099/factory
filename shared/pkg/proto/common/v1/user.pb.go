...
const file_common_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x14common/v1/user.proto\x12\tcommon.v1\x1a\x17validate/validate.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc3\x01\n" +
	"\x04User\x12\x1c\n" +
...
var file_common_v1_user_proto_goTypes = []any{
	...
	(*NotificationMethod)(nil),    // 2: common.v1.NotificationMethod
...
var file_common_v1_user_proto_depIdxs = []int32{
	...
	3, // 2: common.v1.User.updated_at:type_name -> google.protobuf.Timestamp
	2, // 3: common.v1.UserInfo.notification_methods:type_name -> common.v1.NotificationMethod
