...
type WhoamiResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	User          *v1.User               `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`       // Владелец текущей сессии
	Session       *v1.Session            `protobuf:"bytes,2,opt,name=session,proto3" json:"session,omitempty"` // Информация о текущей сессии
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\aauth.v1\x1a\x17validate/validate.proto\x1a\x14common/v1/user.proto\x1a\x17common/v1/session.proto\"@\n" +
	...
	"\rWhoamiRequest\x12+\n" +
	"\fsession_uuid\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\vsessionUuid\"c\n" +
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*v1.Session)(nil),     // 5: common.v1.Session
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	4, // 0: auth.v1.WhoamiResponse.user:type_name -> common.v1.User
	5, // 1: auth.v1.WhoamiResponse.session:type_name -> common.v1.Session
