...
func (x *OrderPaidEvent) GetPaymentMethod() PaymentMethod {
	if x != nil {
...
const file_events_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x15events/v1/order.proto\x12\tevents.v1\x1a\x17validate/validate.proto\"\x89\x02\n" +
	"\x0eOrderPaidEvent\x12'\n" +
	"\n" +
	...
	"\n" +
	"order_uuid\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\torderUuid\x12%\n" +
	"\tuser_uuid\x18\x03 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01R\buserUuid\x12$\n" +
	"\x0ebuild_time_sec\x18\x04 \x01(\x03R\fbuildTimeSec*\xa3\x01\n" +
