...
func (_m *IPaymentService) PayOrder(ctx context.Context, dto model.Payment) (string, error) {
...
func (_c *IPaymentService_PayOrder_Call) Run(run func(ctx context.Context, dto model.Payment)) *IPaymentService_PayOrder_Call {
...
func (_c *IPaymentService_PayOrder_Call) RunAndReturn(run func(context.Context, model.Payment) (string, error)) *IPaymentService_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
